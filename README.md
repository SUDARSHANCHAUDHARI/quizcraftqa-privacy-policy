# QuizCraftQA Privacy Policy

This repository contains the public privacy policy for QuizCraftQA.

- Privacy policy: [PRIVACY_POLICY.md](PRIVACY_POLICY.md)
- Web version: https://sudarshanchaudhari.github.io/quizcraftqa-privacy-policy/
...
QuizCraftQA ("we," "our," or "us") is a web app. QuizCraftQA is a browser-based ISTQB exam-prep and PDF-to-quiz tool that stores study data locally in the browser. This Privacy Policy explains what information the app collects, how it is used, and the choices you have. By installing or using QuizCraftQA you agree to the practices described below.

## Information We Collect

### Location Data
- QuizCraftQA does not collect location data.

### Account Information
- No account is required to use QuizCraftQA.

### Device Information
- PDF text you import, generated quiz questions, study history, settings, and dashboard data may be stored locally in browser storage such as IndexedDB.

## How We Use Your Information

### Location Sharing
- QuizCraftQA does not use your location.

### Account Management
- Generate quizzes and study dashboards in your browser.
- Persist study history locally so you can continue later.

### Service Improvement
- Improve local study workflows.
- We do not operate a backend that receives your PDFs or study history.

## Storage and Retention

### Data Storage
- PDF-derived content, quiz data, and history are stored locally in your browser using IndexedDB/local storage.
- No Sudarshan Tech Labs server is used for core QuizCraftQA processing.

### Data Retention
- Browser-local data remains until you delete it in the app, clear browser storage, or reset your browser profile.
...
### Family Groups
- QuizCraftQA does not use MyFamilyTracker-style family groups unless explicitly described in this policy.
...
### Third Parties
- No quiz/PDF content is shared with third parties by Sudarshan Tech Labs.
- If a future optional AI feature is used, the app should ask before sending selected content to the chosen AI provider.
...
* **Browser storage**: Used to save local study history and quiz data.
* **Local file/PDF access through the browser file picker**: Used only for files you choose.

### Optional Permissions

* File import and browser storage can be cleared or avoided by using a private/temporary browser session.

## Your Rights and Controls

### Location Sharing Control
- No location sharing exists in QuizCraftQA.

### Account Management
- No account is required.

### Data Access
- You can clear app data through the app, browser site settings, or browser storage controls.
...
### Permissions
- You can revoke Android permissions in Android Settings -> Apps -> QuizCraftQA -> Permissions.
...
* **GitHub Repository:** https://github.com/SUDARSHANCHAUDHARI/quizcraftqa-privacy-policy
* **Email:** sunny.sudarshan@gmail.com
* **Main App Repository:** https://github.com/SUDARSHANCHAUDHARI/QuizCraftQA
...
- Subject: "Data Deletion Request - QuizCraftQA"
...
1. Open QuizCraftQA, if installed
...
- No third-party cloud service is required for core QuizCraftQA use.
...
QuizCraftQA is built with privacy in mind. The app is built with:
- Browser-based QA study tooling
- PDF import and quiz generation
...
- **Clarified browser-local PDF/quiz storage and no-backend processing.**
